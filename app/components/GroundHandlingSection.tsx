 ...
 * Displays ground handling services with parallax image effect
 * 
 * Features:
 ...
 */
const GroundHandlingSection: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Section starts at ~600vh (after hero + features + mission/vision + cargo + passenger + catering)
      const sectionStart = viewportHeight * 6;
      ...
      <div className="w-full md:w-1/2 flex items-center p-8 md:p-16 relative order-1 md:order-2">
        ...
        <div className="max-w-xl ml-8 md:ml-16 relative z-10 w-full">
          ...
          <h3 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
            <span className="text-gray-900">{t('services.groundHandling.titlePart1')}</span>
            <br />
            <span className="text-brand-blue">{t('services.groundHandling.titlePart2')}</span>
          </h3>

          {/* Description */}
          <p className="text-gray-600 text-base md:text-lg leading-relaxed">
            {t('services.groundHandling.description')}
          </p>
        </div>
      </div>
    </section>
...
export default GroundHandlingSection;
